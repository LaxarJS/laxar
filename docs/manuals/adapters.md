...
- `create`: the actual factory method to create an adapter for a given widget instance.
...
- Finally, `provideServices` is a callback function that the widget adapter *must call right before instantiating* the widget controller.
