System.register('lib/profiling/output.js', ['npm:babel-runtime@5.8.34/core-js/object/keys', 'npm:angular@1.4.8'], function (_export) {
   var _Object$keys, ng, win;
   ...
   function logForId(axProfiling, wlKey, id) {
      ...
      if (isScopeId) {
         ...
         watchers = flatMap(_Object$keys(profilingData).map(function (id) {
   ...
   return {
      ...
      }, function (_npmAngular148) {
         ng = _npmAngular148['default'];
      }],
      execute: function () {
         /**
...
System.register('lib/profiling/profiling.js', ['npm:babel-runtime@5.8.34/core-js/object/keys', 'npm:angular@1.4.8', 'lib/profiling/output.js'], function (_export) {
   var _Object$keys, ng, output, _module, config, axProfiling, origWatch, win, out, FUNCTION_NAME_REGEXP, name;
   ...
   function detachProfiling(scope) {
      ...
      _Object$keys(axProfiling.widgetIdToScopeId).forEach(function (widgetId) {
   ...
   return {
      setters: [function (_npmBabelRuntime5834CoreJsObjectKeys) {
         ...
         ng = _npmAngular148['default'];
      }, function (_libProfilingOutputJs) {
         output = _libProfilingOutputJs;
      }],
      execute: function () {
         /**
          * Copyright 2015 aixigo AG
         ...
         _module = ng.module('axProfiling', []);

         ///////////////////////////////////////////////////////////////////////////////////////////////////////////

         _module.run(['$rootScope', '$window', 'axConfiguration', function ($rootScope, $window, configuration) {
            win = $window;
            ...
            axProfiling = $window.axProfiling = {
               ...
               reset: function reset() {
                  _Object$keys(axProfiling.items).forEach(function (key) {
...
System.register('lib/runtime/visibility_event_manager.js', [], function (_export) {
   ...
   var senderOptions, subscriberOptions;
   ...
   function create($q, eventBus) {
      ...
      function initiateAreaChange(area, visible) {
         ...
         var event = { area: area, visible: visible };
         eventBus.publish(will, event, senderOptions).then(function () {
   ...
   return {
      setters: [],
      execute: function () {
         senderOptions = { sender: 'AxPageController', deliverToSender: false };
         subscriberOptions = { subscriber: 'AxPageController' };
      }
   };
});

System.register('lib/runtime/locale_event_manager.js', ['npm:babel-runtime@5.8.34/core-js/object/keys', 'lib/utilities/object.js'], function (_export) {
   var _Object$keys, deepClone, senderOptions, subscriberOptions;
   ...
   return {
      setters: [function (_npmBabelRuntime5834CoreJsObjectKeys) {
         _Object$keys = _npmBabelRuntime5834CoreJsObjectKeys['default'];
      }, function (_libUtilitiesObjectJs) {
         deepClone = _libUtilitiesObjectJs.deepClone;
      }],
      execute: function () {
         /**
          * Copyright 2015 aixigo AG
         ...
         senderOptions = { sender: 'AxPageController' };
         subscriberOptions = { subscriber: 'AxPageController' };
      }
   };
});

System.register('lib/runtime/area_helper.js', ['npm:angular@1.4.8'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   function create(q, page, visibilityService) {
      ...
      function attachWaitingAdapters(areaName) {
         ...
         q.all(waitingAdapters.map(function (adapterRef) {
            ...
            if (currentLast) {
               ng.element(currentLast).removeClass('last');
            }
   ...
   return {
      setters: [function (_npmAngular148) {
         ng = _npmAngular148['default'];
      }],
      execute: function () {}
   };
...
System.register('lib/runtime/layout_widget_adapter.js', ['npm:angular@1.4.8'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var ng, $compile, $rootScope, _module, name;
   ...
   return {
      ...
      execute: function () {
         _module = ng.module('axLayoutWidgetAdapter', []).run(['$compile', '$rootScope', function (_$compile_, _$rootScope_) {
            $compile = _$compile_;
...
System.register('lib/loaders/page_loader.js', ['npm:babel-runtime@5.8.34/core-js/object/keys', 'lib/utilities/assert.js', 'lib/utilities/object.js', 'lib/utilities/string.js', 'lib/utilities/path.js', 'lib/json/validator.js', 'lib/loaders/features_provider.js', 'static/schemas/page.js'], function (_export) {
   var _Object$keys, assert, object, string, path, jsonValidator, featuresProvider, pageSchema, SEGMENTS_MATCHER, ID_SEPARATOR, ID_SEPARATOR_MATCHER, SUBTOPIC_SEPARATOR, JSON_SUFFIX_MATCHER, COMPOSITION_EXPRESSION_MATCHER, COMPOSITION_TOPIC_PREFIX;
   ...
   function loadPageRecursively(self, pageName, extensionChain) {
      ...
      return load(self, pageSelfLink).then(function (foundPage) {
            ...
            (function (widgetSpec, index) {
               if (has(widgetSpec, 'composition')) {
                  ...
                  if (!has(widgetSpec, 'id')) {
                     var escapedCompositionName = widgetSpec.composition.replace(SEGMENTS_MATCHER, dashToCamelcase);
                  ...
                  promise = promise.then(function () {
                     ...
                     return processCompositions(self, composition, chain, topPage).then(function () {
                        return composition;
                     });
                  }).then(function (composition) {
   ...
   return {
      setters: [function (_npmBabelRuntime5834CoreJsObjectKeys) {
         _Object$keys = _npmBabelRuntime5834CoreJsObjectKeys['default'];
      }, function (_libUtilitiesAssertJs) {
         assert = _libUtilitiesAssertJs['default'];
      }, function (_libUtilitiesObjectJs) {
         object = _libUtilitiesObjectJs;
      }, function (_libUtilitiesStringJs) {
         string = _libUtilitiesStringJs;
      }, function (_libUtilitiesPathJs) {
         path = _libUtilitiesPathJs;
      }, function (_libJsonValidatorJs) {
         jsonValidator = _libJsonValidatorJs;
      }, function (_libLoadersFeatures_providerJs) {
         featuresProvider = _libLoadersFeatures_providerJs;
      }, function (_staticSchemasPageJs) {
         pageSchema = _staticSchemasPageJs;
      }],
      execute: function () {
         /**
          * Copyright 2015 aixigo AG
         ...
         SEGMENTS_MATCHER = /[_/-]./g;
         ID_SEPARATOR = '-';
         ID_SEPARATOR_MATCHER = /\-/g;
         SUBTOPIC_SEPARATOR = '+';
         JSON_SUFFIX_MATCHER = /\.json$/;
         COMPOSITION_EXPRESSION_MATCHER = /^(!?)\$\{([^}]+)\}$/;
         COMPOSITION_TOPIC_PREFIX = 'topic:';
...
System.register('lib/runtime/page.js', ['lib/utilities/assert.js', 'npm:angular@1.4.8', 'lib/directives/layout/layout.js', 'lib/loaders/page_loader.js', 'lib/loaders/widget_loader.js', 'lib/loaders/paths.js', 'lib/runtime/layout_widget_adapter.js', 'lib/runtime/flow.js', 'lib/runtime/area_helper.js', 'lib/runtime/locale_event_manager.js', 'lib/runtime/visibility_event_manager.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var codeIsUnreachable, ng, layoutModule, pageLoader, widgetLoader, paths, layoutWidgetAdapter, flowModule, createAreaHelper, createLocaleEventManager, createVisibilityEventManager, _module, WIDGET_ATTACH_DELAY_MS, name;

   return {
      setters: [function (_libUtilitiesAssertJs) {
         codeIsUnreachable = _libUtilitiesAssertJs.codeIsUnreachable;
      }, function (_npmAngular148) {
         ng = _npmAngular148['default'];
      }, function (_libDirectivesLayoutLayoutJs) {
         layoutModule = _libDirectivesLayoutLayoutJs;
      }, function (_libLoadersPage_loaderJs) {
         pageLoader = _libLoadersPage_loaderJs;
      }, function (_libLoadersWidget_loaderJs) {
         widgetLoader = _libLoadersWidget_loaderJs;
      }, function (_libLoadersPathsJs) {
         paths = _libLoadersPathsJs;
      }, function (_libRuntimeLayout_widget_adapterJs) {
         layoutWidgetAdapter = _libRuntimeLayout_widget_adapterJs;
      }, function (_libRuntimeFlowJs) {
         flowModule = _libRuntimeFlowJs;
      }, function (_libRuntimeArea_helperJs) {
         createAreaHelper = _libRuntimeArea_helperJs.create;
      }, function (_libRuntimeLocale_event_managerJs) {
         createLocaleEventManager = _libRuntimeLocale_event_managerJs.create;
      }, function (_libRuntimeVisibility_event_managerJs) {
         createVisibilityEventManager = _libRuntimeVisibility_event_managerJs.create;
      }],
      execute: function () {
         _module = ng.module('axPage', [layoutModule.name, layoutWidgetAdapter.name, flowModule.name]);

         /** Delay between sending didLifeCycle and attaching widget templates. */
         WIDGET_ATTACH_DELAY_MS = 5;
          ...
          */
         _module.service('axPageService', [function () {
            ...
            return {
               ...
               registerPageController: function registerPageController(controller) {
                  pageController = controller;
                  return function () {
                     pageController = null;
                  };
               },
               controllerForScope: function controllerForScope(scope) {
                  return pageController;
               }
            };
         }]);
         ...
         (function () {
            ...
            var axServiceDependencies = ['axConfiguration', 'axControls', 'axCssLoader', 'axFileResourceProvider', 'axFlowService', 'axGlobalEventBus', 'axHeartbeat', 'axI18n', 'axLayoutLoader', 'axThemeManager', 'axTimestamp', 'axVisibilityService'];

            var createPageControllerInjected = pageControllerDependencies.concat(axServiceDependencies).concat(function ($scope, $q, $timeout, pageService) {
               ...
               var renderLayout = function renderLayout(layoutInfo) {
               ...
               function beginLifecycle() {
                  return eventBus.publishAndGatherReplies('beginLifecycleRequest.default', lifecycleEvent, senderOptions);
               }
               ...
               function setupPage(pageName) {
                  ...
                  var pagePromise = pageLoader_.loadPage(pageName).then(function (page) {
                     ...
                     widgetAdapters.forEach(function (adapter) {
                        if (typeof adapter.applyViewChanges === 'function' && viewChangeApplyFunctions_.indexOf(adapter.applyViewChanges) === -1) {
                           viewChangeApplyFunctions_.push(adapter.applyViewChanges);
                        }
                     });
                     widgetAdapters_ = widgetAdapters;
                  }).then(localeManager.initialize).then(publishTheme).then(beginLifecycle).then(visibilityManager.initialize);
                  ...
                  return $q.all([layoutReady, widgetsInitialized]).then(function () {
               ...
               function tearDownPage() {
                  ...
                  return eventBus.publishAndGatherReplies('endLifecycleRequest.default', lifecycleEvent, senderOptions).then(function () {
            ...
            _module.controller('AxPageController', createPageControllerInjected);
         })();

         ///////////////////////////////////////////////////////////////////////////////////////////////////////////

         _module.directive('axPage', ['$compile', function ($compile) {
                  ...
                  controller.registerLayoutRenderer(function (layoutInfo) {
                     ...
                     var defaultAreaHtml = defaultAreas.reduce(function (html, area) {
                        if (!controller.areas.exists(area.name)) {
                           return html + '<div data-ax-widget-area="' + area.name + '"' + (area.hidden ? ' style="display: none;"' : '') + '></div>';
                        }
                        return html;
                     }, '');
...
System.register('lib/utilities/timer.js', ['lib/utilities/object.js', 'lib/utilities/storage.js', 'lib/logging/log.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var object, storage, log, idCounter, store;

   ///////////////////////////////////////////////////////////////////////////////////////////////////////////

   _export('started', started);

   _export('resumedOrStarted', resumedOrStarted);
   ...
   return {
      setters: [function (_libUtilitiesObjectJs) {
         object = _libUtilitiesObjectJs;
      }, function (_libUtilitiesStorageJs) {
         storage = _libUtilitiesStorageJs['default'];
      }, function (_libLoggingLogJs) {
         log = _libLoggingLogJs['default'];
      }],
      execute: function () {
         idCounter = 0;
         store = storage.getSessionStorage('timer');
...
System.register('lib/runtime/flow.js', ['npm:angular@1.4.8', 'npm:angular-route@1.4.8', 'lib/logging/log.js', 'lib/json/validator.js', 'lib/utilities/object.js', 'lib/utilities/timer.js', 'lib/utilities/path.js', 'lib/loaders/paths.js', 'static/schemas/flow.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var ng, ngRoute, log, jsonValidator, object, timer, path, paths, flowSchema, _module, $routeProvider_, fileResourceProvider_, exitPoints_, entryPoint_, SESSION_KEY_TIMER, TARGET_SELF, activeTarget_, activePlace_, activeParameters_, places_, previousNavigateRequestSubscription_, navigationInProgress_, navigationTimer_, eventOptions, subscriberOptions, ROUTE_PARAMS_MATCHER, name;
   ...
   function loadFlow(flowFile) {
      return fetchPlaces(flowFile).then(function (places) {
   ...
   function assembleRoute(routeName, _place) {
      if (_place.redirectTo) {
         $routeProvider_.when('/' + routeName, {
            redirectTo: _place.redirectTo
         });
         return;
      }

      if (_place.entryPoints) {
         $routeProvider_.when('/' + routeName, {
            redirectTo: routeByEntryPoint(_place.entryPoints)
         });
         return;
      }

      if (!_place.page && !_place.exitPoint) {
         log.warn('flow: invalid empty place: [0]', _place.id);
         return;
      }
   ...
   function fetchPlaces(flowFile) {
      return fileResourceProvider_.provide(flowFile).then(function (flow) {
   ...
   return {
      setters: [function (_npmAngular148) {
         ng = _npmAngular148['default'];
      }, function (_npmAngularRoute148) {
         ngRoute = _npmAngularRoute148;
      }, function (_libLoggingLogJs) {
         log = _libLoggingLogJs['default'];
      }, function (_libJsonValidatorJs) {
         jsonValidator = _libJsonValidatorJs;
         ...
         object = _libUtilitiesObjectJs;
      }, function (_libUtilitiesTimerJs) {
         timer = _libUtilitiesTimerJs;
      }, function (_libUtilitiesPathJs) {
         path = _libUtilitiesPathJs;
      }, function (_libLoadersPathsJs) {
         paths = _libLoadersPathsJs;
      }, function (_staticSchemasFlowJs) {
         flowSchema = _staticSchemasFlowJs.schema;
      }],
      execute: function () {
         _module = ng.module('axFlow', ['ngRoute']);
         ...
         _module.run(['$route', 'axConfiguration', 'axFileResourceProvider', function ($route, configuration, fileResourceProvider) {
         ...
         SESSION_KEY_TIMER = 'navigationTimer';
         TARGET_SELF = '_self';
         activeTarget_ = TARGET_SELF;
         activePlace_ = null;
         activeParameters_ = {};
         navigationInProgress_ = false;
         eventOptions = { sender: 'AxFlowController' };
         subscriberOptions = { subscriber: 'AxFlowController' };

         ///////////////////////////////////////////////////////////////////////////////////////////////////////////

         _module.controller('AxFlowController', ['$window', '$location', '$routeParams', 'place', 'axGlobalEventBus', 'axFlowService', 'axPageService', function FlowController($window, $location, $routeParams, place, eventBus, flowService, pageService) {
            ...
            eventBus.publish('willNavigate.' + activeTarget_, navigateEvent, eventOptions).then(function () {
            ...
            function handleNavigateRequest(event, meta) {
               ...
               navigationTimer_ = timer.started({
                  label: ['navigation (', place ? place.targets._self : '', ' -> ', newPlace.targets._self, ')'].join(''),
                  persistenceKey: SESSION_KEY_TIMER
               });
          ...
          * @injection
          */
         _module.factory('axFlowService', ['$location', function ($location) {
            ...
            var flowService = {
                ...
                */
               constructPath: function constructPath(targetOrPlace, optionalParameters) {
                ...
                * @memberOf axFlowService
                */
               constructAnchor: function constructAnchor(targetOrPlace, optionalParameters) {
                ...
                * @memberOf axFlowService
                */
               constructAbsoluteUrl: function constructAbsoluteUrl(targetOrPlace, optionalParameters) {
...
System.register('lib/runtime/theme_manager.js', ['lib/utilities/path.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   return {
      setters: [function (_libUtilitiesPathJs) {
         path = _libUtilitiesPathJs;
      }],
      execute: function () {
         ...
         ThemeManager.prototype.urlProvider = function (artifactPathPattern, themePathPattern, fallbackPathPatterns) {
            ...
            return {
               provide: function provide(fileNames) {
                  ...
                  return self.q_.all(promises).then(function (results) {
...
System.register('lib/runtime/controls_service.js', ['lib/utilities/path.js', 'lib/utilities/string.js', 'lib/loaders/paths.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   return {
      setters: [function (_libUtilitiesPathJs) {
         ...
         format = _libUtilitiesStringJs.format;
      }, function (_libLoadersPathsJs) {
         paths = _libLoadersPathsJs;
      }],
      execute: function () {}
...
System.register('lib/loaders/layout_loader.js', ['lib/utilities/path.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
...
System.register('lib/runtime/runtime_services.js', ['npm:angular@1.4.8', 'lib/event_bus/event_bus.js', 'lib/i18n/i18n.js', 'lib/file_resource_provider/file_resource_provider.js', 'lib/logging/log.js', 'lib/utilities/object.js', 'lib/utilities/path.js', 'lib/loaders/layout_loader.js', 'lib/loaders/paths.js', 'lib/utilities/configuration.js', 'lib/runtime/controls_service.js', 'lib/runtime/theme_manager.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var ng, eventBus, i18n, fileResourceProvider, log, object, path, layoutLoader, paths, configuration, controlsService, themeManager, _module, $qProvider_, CONFIG_KEY_HTTP_LOGGING_HEADER, sensitiveData, name;
   ...
   return {
      setters: [function (_npmAngular148) {
         ng = _npmAngular148['default'];
      }, function (_libEvent_busEvent_busJs) {
         eventBus = _libEvent_busEvent_busJs;
      }, function (_libI18nI18nJs) {
         i18n = _libI18nI18nJs;
      }, function (_libFile_resource_providerFile_resource_providerJs) {
         fileResourceProvider = _libFile_resource_providerFile_resource_providerJs;
      }, function (_libLoggingLogJs) {
         log = _libLoggingLogJs['default'];
      }, function (_libUtilitiesObjectJs) {
         object = _libUtilitiesObjectJs;
         ...
         path = _libUtilitiesPathJs;
      }, function (_libLoadersLayout_loaderJs) {
         layoutLoader = _libLoadersLayout_loaderJs;
      }, function (_libLoadersPathsJs) {
         paths = _libLoadersPathsJs;
      }, function (_libUtilitiesConfigurationJs) {
         configuration = _libUtilitiesConfigurationJs;
      }, function (_libRuntimeControls_serviceJs) {
         controlsService = _libRuntimeControls_serviceJs;
      }, function (_libRuntimeTheme_managerJs) {
         themeManager = _libRuntimeTheme_managerJs;
      }],
      execute: function () {
         _module = ng.module('axRuntimeServices', []);

         ///////////////////////////////////////////////////////////////////////////////////////////////////////////

         _module.config(['$qProvider', '$httpProvider', function ($qProvider, $httpProvider) {
          ...
          * @injection
          */
         _module.factory('axHeartbeat', ['$window', '$rootScope', 'axPageService', function ($window, $rootScope, pageService) {
            var nextQueue = [];
          ...
          * @injection
          */
         _module.factory('axTimestamp', function () {
            return function () {
               return new Date().getTime();
            };
         });
          ...
          * @injection
          */
         _module.factory('axControls', ['axFileResourceProvider', function (fileResourceProvider) {
          ...
          * @injection
          */
         _module.factory('axGlobalEventBus', ['$injector', '$window', 'axHeartbeat', 'axConfiguration', function ($injector, $window, heartbeat, configuration) {
          ...
          * @injection
          */
         _module.factory('axConfiguration', [function () {
          ...
          * @injection
          */
         _module.factory('axI18n', [function () {
            return i18n;
         }]);
          ...
          * @injection
          */
         _module.factory('axFileResourceProvider', ['$q', '$http', 'axConfiguration', function ($q, $http, configuration) {
          ...
          * @injection
          */
         _module.factory('axThemeManager', ['$q', 'axConfiguration', 'axFileResourceProvider', function ($q, configuration, fileResourceProvider) {
          ...
          * @injection
          */
         _module.factory('axLayoutLoader', ['$templateCache', 'axCssLoader', 'axThemeManager', 'axFileResourceProvider', function ($templateCache, cssLoader, themeManager, fileResourceProvider) {
            return layoutLoader.create(paths.LAYOUTS, paths.THEMES, cssLoader, themeManager, fileResourceProvider, $templateCache);
         }]);
          ...
          * @injection
          */
         _module.factory('axCssLoader', ['axConfiguration', 'axThemeManager', function (configuration, themeManager) {
         ...
         _module.factory('axLogHttpInterceptor', ['axConfiguration', function (configuration) {
         ...
         CONFIG_KEY_HTTP_LOGGING_HEADER = 'logging.http.header';
          ...
          * @private
          */
         _module.provider('$exceptionHandler', function () {
            var handler = function handler(exception, cause) {
...
System.register('lib/runtime/runtime_dependencies.js', ['npm:angular@1.4.8', 'npm:angular-sanitize@1.4.8', 'lib/runtime/runtime_services.js', 'lib/runtime/flow.js', 'lib/runtime/page.js', 'lib/directives/directives.js', 'lib/profiling/profiling.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var ng, ngSanitizeModule, runtimeServicesModule, flowModule, pageModule, directives, profilingModule, name;
   return {
      setters: [function (_npmAngular148) {
         ng = _npmAngular148['default'];
      }, function (_npmAngularSanitize148) {
         ngSanitizeModule = _npmAngularSanitize148;
      }, function (_libRuntimeRuntime_servicesJs) {
         runtimeServicesModule = _libRuntimeRuntime_servicesJs;
      }, function (_libRuntimeFlowJs) {
         flowModule = _libRuntimeFlowJs;
      }, function (_libRuntimePageJs) {
         pageModule = _libRuntimePageJs;
      }, function (_libDirectivesDirectivesJs) {
         directives = _libDirectivesDirectivesJs;
      }, function (_libProfilingProfilingJs) {
         profilingModule = _libProfilingProfilingJs;
      }],
      execute: function () {
         name = ng.module('axRuntimeDependencies', ['ngSanitize', runtimeServicesModule.name, flowModule.name, pageModule.name, directives.id.name, directives.widgetArea.name, profilingModule.name]).name;
...
System.register('lib/runtime/runtime.js', ['npm:angular@1.4.8', 'lib/utilities/assert.js', 'lib/utilities/path.js', 'lib/loaders/paths.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var ng, codeIsUnreachable, join, paths, _module, api;
   ...
   return {
      setters: [function (_npmAngular148) {
         ...
         join = _libUtilitiesPathJs.join;
      }, function (_libLoadersPathsJs) {
         paths = _libLoadersPathsJs;
      }],
      execute: function () {
         _module = ng.module('axRuntime', []);
         api = {
         ...
         _module.run(['axCssLoader', 'axThemeManager', function (CssLoader, themeManager) {
            themeManager.urlProvider(join(paths.THEMES, '[theme]'), null, [paths.DEFAULT_THEME]).provide(['css/theme.css']).then(function (files) {
         ...
         _export('default', { module: _module, api: api });
      }
   };
});

System.register('lib/utilities/storage.js', ['lib/utilities/assert.js', 'lib/utilities/configuration.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var assert, configuration, SESSION, LOCAL, instance;
...
System.register('lib/widget_adapters/angular_adapter.js', ['npm:angular@1.4.8', 'lib/utilities/assert.js', 'lib/logging/log.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var ng, assert, log, $compile, $controller, $rootScope, controllerNames, technology;
   ...
   function bootstrap(widgetModules) {
      ...
      return ng.module('axAngularWidgetAdapter', dependencies).run(['$compile', '$controller', '$rootScope', function (_$compile_, _$controller_, _$rootScope_) {
   ...
   function supportPreviousNaming(moduleName) {
      ...
      var lookupName = moduleName.replace(/^.*\.([^.]+)$/, function ($_, $1) {
         return $1.replace(/_(.)/g, function ($_, $1) {
            return $1.toUpperCase();
         });
      });
      controllerNames[lookupName] = controllerNames[moduleName] = moduleName + '.Controller';

      log.warn('Deprecation: AngularJS widget module name "' + moduleName + '" violates naming rules! ' + 'Module should be named "' + lookupName + '". ' + 'Controller should be named "' + capitalize(lookupName) + 'Controller".');
   }
   return {
      setters: [function (_npmAngular148) {
         ng = _npmAngular148['default'];
...
System.register('lib/widget_adapters/adapters.js', ['npm:babel-runtime@5.8.34/helpers/define-property', 'npm:babel-runtime@5.8.34/core-js/object/keys', 'lib/widget_adapters/plain_adapter.js', 'lib/widget_adapters/angular_adapter.js'], function (_export) {
   ...
   return {
      ...
      }, function (_libWidget_adaptersAngular_adapterJs) {
         angularAdapter = _libWidget_adaptersAngular_adapterJs;
      }],
      execute: function () {
         /**
          * Copyright 2015 aixigo AG
         ...
         _export('getFor', getFor);

         _export('getSupportedTechnologies', getSupportedTechnologies);
...
System.register('lib/json/schema.js', ['npm:babel-runtime@5.8.34/core-js/object/keys', 'lib/utilities/object.js'], function (_export) {
   var _Object$keys, object;
         ...
         switch (key) {
            ...
            case 'patternProperties':
               ...
               object.forEach(value, function (patternSchema, pattern) {
                  resultingSchema[key][pattern] = transformV3V4Recursively(patternSchema, pattern, resultingSchema, schema);
               });
               break;
   ...
   function isNamedProperty(key, parentSchema) {
      return parentSchema && schemaAllowsType(parentSchema, 'object') && object.path(parentSchema, 'properties.' + key);
   }
   ...
   return {
      ...
      execute: function () {
         ...
         _export('transformV3ToV4', transformV3ToV4);

         _export('prohibitAdditionalProperties', prohibitAdditionalProperties);
      }
   };
});
...
System.registerDynamic("npm:jjv@1.0.2/index", ["npm:jjv@1.0.2/lib/jjv"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  module.exports = $__require('npm:jjv@1.0.2/lib/jjv');
  global.define = __define;
  return module.exports;
});
...
System.register('lib/json/validator.js', ['npm:jjv@1.0.2', 'npm:jjve@0.5.1', 'lib/json/schema.js', 'lib/utilities/object.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var jjv, jjve, schema, objectUtils, JSON_SCHEMA_V4_URI;
   ...
   return {
      setters: [function (_npmJjv102) {
         jjv = _npmJjv102['default'];
      }, function (_npmJjve051) {
         jjve = _npmJjve051['default'];
      }, function (_libJsonSchemaJs) {
         schema = _libJsonSchemaJs;
      }, function (_libUtilitiesObjectJs) {
         objectUtils = _libUtilitiesObjectJs;
      }],
      execute: function () {
         JSON_SCHEMA_V4_URI = 'http://json-schema.org/draft-04/schema#';

         _export('JSON_SCHEMA_V4_URI', JSON_SCHEMA_V4_URI);
      }
   };
});

System.register('lib/loaders/features_provider.js', ['npm:babel-runtime@5.8.34/core-js/object/keys', 'lib/json/validator.js', 'lib/utilities/object.js', 'lib/utilities/string.js'], function (_export) {
   var _Object$keys, jsonValidator, object, string, TOPIC_IDENTIFIER, SUB_TOPIC_FORMAT, TOPIC_FORMAT, FLAG_TOPIC_FORMAT, LANGUAGE_TAG_FORMAT;
   ...
   return {
      ...
      execute: function () {
         ...
         TOPIC_IDENTIFIER = '([a-z][+a-zA-Z0-9]*|[A-Z][+A-Z0-9]*)';
         SUB_TOPIC_FORMAT = new RegExp('^' + TOPIC_IDENTIFIER + '$');
         TOPIC_FORMAT = new RegExp('^(' + TOPIC_IDENTIFIER + '(-' + TOPIC_IDENTIFIER + ')*)$');
         FLAG_TOPIC_FORMAT = new RegExp('^[!]?(' + TOPIC_IDENTIFIER + '(-' + TOPIC_IDENTIFIER + ')*)$');
         ...
         _export('featuresForWidget', featuresForWidget);
      }
   };
});
...
System.register('lib/loaders/paths.js', [], function (_export) {
  ...
  var PRODUCT, THEMES, LAYOUTS, CONTROLS, WIDGETS, PAGES, FLOW_JSON, DEFAULT_THEME;
  return {
    setters: [],
    execute: function () {
      PRODUCT = '';
      ...
      DEFAULT_THEME = 'bower_components/laxar-uikit/dist/themes/default.theme';

      _export('PRODUCT', PRODUCT);

      _export('THEMES', THEMES);

      _export('LAYOUTS', LAYOUTS);

      _export('CONTROLS', CONTROLS);

      _export('WIDGETS', WIDGETS);

      _export('PAGES', PAGES);

      _export('FLOW_JSON', FLOW_JSON);

      _export('DEFAULT_THEME', DEFAULT_THEME);

      _export('default', { PRODUCT: PRODUCT, THEMES: THEMES, LAYOUTS: LAYOUTS, CONTROLS: CONTROLS, WIDGETS: WIDGETS, PAGES: PAGES, FLOW_JSON: FLOW_JSON, DEFAULT_THEME: DEFAULT_THEME });
    }
  };
});

System.register('lib/loaders/widget_loader.js', ['lib/utilities/assert.js', 'lib/logging/log.js', 'lib/utilities/path.js', 'lib/utilities/object.js', 'lib/utilities/string.js', 'lib/loaders/paths.js', 'lib/loaders/features_provider.js', 'lib/widget_adapters/adapters.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var assert, log, path, object, string, paths, featuresProvider, adapters, TYPE_WIDGET, TYPE_ACTIVITY, TECHNOLOGY_ANGULAR, DEFAULT_INTEGRATION, ID_SEPARATOR, INVALID_ID_MATCHER;
   ...
   function create(q, services) {
      ...
      function load(widgetConfiguration, optionalOptions) {
         ...
         return fileResourceProvider.provide(widgetJsonPath).then(function (specification) {
            ...
            return q.all((specification.controls || []).map(controlsService.load)).then(function (descriptors) {
      ...
      function loadAssets(widgetPath, integration, widgetSpecification, widgetConfiguration) {
         ...
         function resolve() {
            ...
            var promises = [];
            promises.push(themeManager.urlProvider(path.join(widgetPath, '[theme]'), path.join(paths.THEMES, '[theme]', 'widgets', specifiedName), [path.join(paths.THEMES, '[theme]', 'widgets', refPath)]).provide([specifiedHtmlFile, specifiedCssFile, technicalHtmlFile, technicalCssFile]));
   ...
   function checkTechnologyCompatibility(widgetDescriptor) {
      return function (controlDescriptor) {
         ...
         log.warn('Incompatible integration technologies: widget [0] ([1]) cannot use control [2] ([3])', widgetDescriptor.name, widgetTechnology, controlDescriptor.name, controlTechnology);
      };
   }
   ...
   return {
      setters: [function (_libUtilitiesAssertJs) {
         ...
         featuresProvider = _libLoadersFeatures_providerJs;
      }, function (_libWidget_adaptersAdaptersJs) {
         adapters = _libWidget_adaptersAdaptersJs;
      }],
      execute: function () {
         TYPE_WIDGET = 'widget';
         TYPE_ACTIVITY = 'activity';
         TECHNOLOGY_ANGULAR = 'angular';
         DEFAULT_INTEGRATION = { type: TYPE_WIDGET, technology: TECHNOLOGY_ANGULAR };
         ID_SEPARATOR = '-';
         INVALID_ID_MATCHER = /[^A-Za-z0-9_\.-]/g;
      }
   };
});

System.register('lib/i18n/i18n.js', ['npm:babel-runtime@5.8.34/core-js/object/keys', 'lib/utilities/assert.js', 'lib/utilities/string.js', 'lib/utilities/configuration.js'], function (_export) {
   var _Object$keys, assert, string, configuration, localize, primitives, fallbackTag, normalize, format, keys;
   ...
   return {
      ...
      execute: function () {
         ...
         normalize = memoize(function (languageTag) {
         ...
         _export('localize', localize);

         _export('localizeStrict', localizeStrict);

         _export('localizeRelaxed', localizeRelaxed);

         _export('localizer', localizer);

         _export('languageTagFromI18n', languageTagFromI18n);
      }
   };
});

System.register('lib/utilities/path.js', ['lib/utilities/assert.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var assert, PATH_SEPARATOR, PARENT, ABSOLUTE, schemeLoaders;
   ...
   _export('relative', relative);

   _export('resolveAssetPath', resolveAssetPath);
...
System.register('lib/file_resource_provider/file_resource_provider.js', ['npm:babel-runtime@5.8.34/core-js/object/keys', 'lib/utilities/assert.js', 'lib/utilities/string.js', 'lib/utilities/path.js', 'lib/utilities/configuration.js'], function (_export) {
   var _Object$keys, assert, string, path, configuration, q_, httpClient_, BORDER_SLASHES_MATCHER, ENTRY_TYPE_FILE;
   ...
   function httpGet(self, url) {
      ...
      var promise = self.httpGets_[url] = httpClient_.get(url, { transformResponse: [] }).then(function (response) {
   ...
   function httpHead(self, url) {
      ...
      var promise = self.httpHeads_[url] = httpClient_.head(url).then(function () {
         return true;
      }, function () {
         return false;
      });
...
System.register('lib/event_bus/event_bus.js', ['npm:babel-runtime@5.8.34/core-js/object/keys', 'lib/utilities/assert.js', 'lib/logging/log.js', 'lib/utilities/object.js'], function (_export) {
   var _Object$keys, assert, log, object, q_, nextTick_, timeoutFunction_, WILDCARD, SUBSCRIBER_FIELD, INTERNAL_EVENTS_REGISTRY, PART_SEPARATOR, SUB_PART_SEPARATOR, REQUEST_MATCHER;
   ...
   function create(optionalConfiguration) {
      assert(q_).isNotNull('Need a promise implementation like $q or Q');
      assert(nextTick_).hasType(Function).isNotNull('Need a next tick implementation like $timeout');
      assert(timeoutFunction_).hasType(Function).isNotNull('Need a timeout implementation like $timeout or setTimeout');
   ...
   return {
      ...
      execute: function () {
         ...
         WILDCARD = '*';
         SUBSCRIBER_FIELD = '.';
         INTERNAL_EVENTS_REGISTRY = 'ax__events';
         PART_SEPARATOR = '.';
         SUB_PART_SEPARATOR = '-';
         ...
         EventBus.prototype.publishAndGatherReplies = function (eventName, optionalEvent, optionalOptions) {
            ...
            function willCollector(event, meta) {
               assert(meta.sender).hasType(String).isNotNull('A response with will to a request-event must contain a sender.');
...
System.register('lib/utilities/string.js', ['npm:babel-runtime@5.8.34/core-js/object/freeze', 'npm:babel-runtime@5.8.34/core-js/object/keys'], function (_export) {
   var _Object$freeze, _Object$keys, DEFAULT_FORMATTERS, DEFAULT_FORMATTER, BACKSLASH, OPENING_BRACKET, CLOSING_BRACKET, INTEGER_MATCHER;
            ...
            return placeholderParts.slice(1).reduce(function (value, part) {
               if (part.indexOf('%') === 0) {
                  ...
                  if (specifier in typeFormatters) {
                     ...
                     var knownSpecifiers = _Object$keys(typeFormatters).filter(function (_) {
                        return _ !== 'default';
                     }).map(function (_) {
                        return '%' + _;
                     }).join(', ');
   ...
   return {
      setters: [function (_npmBabelRuntime5834CoreJsObjectFreeze) {
         _Object$freeze = _npmBabelRuntime5834CoreJsObjectFreeze['default'];
      }, function (_npmBabelRuntime5834CoreJsObjectKeys) {
         _Object$keys = _npmBabelRuntime5834CoreJsObjectKeys['default'];
      }],
      execute: function () {
         ...
         _export('DEFAULT_FORMATTERS', DEFAULT_FORMATTERS);

         if (typeof _Object$freeze === 'function') {
            _Object$freeze(DEFAULT_FORMATTERS);
         }DEFAULT_FORMATTER = createFormatter(DEFAULT_FORMATTERS);
         BACKSLASH = '\\';
         OPENING_BRACKET = '[';
         CLOSING_BRACKET = ']';
         INTEGER_MATCHER = /^[0-9]+$/;
...
System.register('lib/directives/widget_area/widget_area.js', ['npm:angular@1.4.8', 'lib/utilities/string.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var ng, string, _module, DIRECTIVE_NAME, name;

   return {
      setters: [function (_npmAngular148) {
         ng = _npmAngular148['default'];
      }, function (_libUtilitiesStringJs) {
         string = _libUtilitiesStringJs['default'];
      }],
      execute: function () {
         _module = ng.module('axWidgetArea', []);
         DIRECTIVE_NAME = 'axWidgetArea';
          ...
          * @directive
          */
         _module.directive(DIRECTIVE_NAME, ['axPageService', function (pageService) {
            return {
               restrict: 'A',
...
System.register('lib/directives/layout/layout.js', ['npm:angular@1.4.8', 'lib/logging/log.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var ng, log, _module, DIRECTIVE_NAME, name;
   ...
   return {
      ...
      execute: function () {
         _module = ng.module('axLayout', []);
         DIRECTIVE_NAME = 'axLayout';
          ...
          * @directive
          */
         _module.directive(DIRECTIVE_NAME, ['axLayoutLoader', '$compile', function (layoutLoader, $compile) {

            return {
               restrict: 'A',
               link: function link(scope, element, attrs) {
                  var layoutName = scope.$eval(attrs[DIRECTIVE_NAME]);
                  layoutLoader.load(layoutName).then(function (layoutInfo) {
                     element.html(layoutInfo.htmlContent);
...
System.register('lib/directives/id/id.js', ['npm:angular@1.4.8', 'lib/utilities/assert.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var ng, assert, _module, ID_DIRECTIVE_NAME, FOR_DIRECTIVE_NAME, name;
   ...
   return {
      ...
      execute: function () {
          ...
          * @directive
          */
         _module.directive(ID_DIRECTIVE_NAME, [function () {
            return {
               restrict: 'A',
               link: function link(scope, element, attrs) {
          ...
          * @directive
          */
         _module.directive(FOR_DIRECTIVE_NAME, [function () {
            return {
               restrict: 'A',
               link: function link(scope, element, attrs) {
...
System.register('lib/directives/directives.js', ['lib/directives/id/id.js', 'lib/directives/layout/layout.js', 'lib/directives/widget_area/widget_area.js'], function (_export) {
  /**
   * Copyright 2015 aixigo AG
   * Released under the MIT license.
   * http://laxarjs.org/license
  ...
  var id, layout, widgetArea;
  return {
    setters: [function (_libDirectivesIdIdJs) {
      id = _libDirectivesIdIdJs;
    }, function (_libDirectivesLayoutLayoutJs) {
      layout = _libDirectivesLayoutLayoutJs;
    }, function (_libDirectivesWidget_areaWidget_areaJs) {
      widgetArea = _libDirectivesWidget_areaWidget_areaJs;
    }],
    execute: function () {
      _export('id', id);
...
System.registerDynamic("npm:core-js@1.2.6/library/fn/object/freeze", ["npm:core-js@1.2.6/library/modules/es6.object.freeze", "npm:core-js@1.2.6/library/modules/$.core"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  $__require('npm:core-js@1.2.6/library/modules/es6.object.freeze');
  module.exports = $__require('npm:core-js@1.2.6/library/modules/$.core').Object.freeze;
  global.define = __define;
  return module.exports;
});

System.registerDynamic("npm:babel-runtime@5.8.34/core-js/object/freeze", ["npm:core-js@1.2.6/library/fn/object/freeze"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  module.exports = {
    "default": $__require('npm:core-js@1.2.6/library/fn/object/freeze'),
    __esModule: true
  };
  global.define = __define;
  return module.exports;
...
System.registerDynamic("npm:core-js@1.2.6/library/fn/object/is-frozen", ["npm:core-js@1.2.6/library/modules/es6.object.is-frozen", "npm:core-js@1.2.6/library/modules/$.core"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  $__require('npm:core-js@1.2.6/library/modules/es6.object.is-frozen');
  module.exports = $__require('npm:core-js@1.2.6/library/modules/$.core').Object.isFrozen;
  global.define = __define;
  return module.exports;
});

System.registerDynamic("npm:babel-runtime@5.8.34/core-js/object/is-frozen", ["npm:core-js@1.2.6/library/fn/object/is-frozen"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  module.exports = {
    "default": $__require('npm:core-js@1.2.6/library/fn/object/is-frozen'),
    __esModule: true
  };
  global.define = __define;
  return module.exports;
...
System.register('lib/utilities/object.js', ['npm:babel-runtime@5.8.34/core-js/object/is-frozen', 'npm:babel-runtime@5.8.34/core-js/object/freeze'], function (_export) {
   var _Object$isFrozen, _Object$freeze, slice, hasOwnProp;
   ...
   return {
      setters: [function (_npmBabelRuntime5834CoreJsObjectIsFrozen) {
         _Object$isFrozen = _npmBabelRuntime5834CoreJsObjectIsFrozen['default'];
      }, function (_npmBabelRuntime5834CoreJsObjectFreeze) {
         _Object$freeze = _npmBabelRuntime5834CoreJsObjectFreeze['default'];
      }],
      execute: function () {
         /**
...
System.register('lib/utilities/configuration.js', ['lib/utilities/object.js'], function (_export) {
  /**
   * Copyright 2015 aixigo AG
   * Released under the MIT license.
   * http://laxarjs.org/license
  ...
  return {
    setters: [function (_libUtilitiesObjectJs) {
      path = _libUtilitiesObjectJs.path;
    }],
    execute: function () {
...
System.register('lib/utilities/assert.js', [], function (_export) {
   ...
   var TYPE_TO_CONSTRUCTOR, FUNCTION_NAME_MATCHER, codeIsUnreachable, state;
   ...
   function fail(message, optionalDetails) {
      if (optionalDetails) {
         message += ' Details: ' + (typeof optionalDetails === 'object' ? JSON.stringify(optionalDetails) : optionalDetails);
      }
   ...
   return {
      ...
      execute: function () {
         ...
         FUNCTION_NAME_MATCHER = /^function ([^\(]*)\(/i;
         ...
         _export('default', assert);

         codeIsUnreachable = assert.codeIsUnreachable;

         _export('codeIsUnreachable', codeIsUnreachable);
...
System.register('lib/logging/log.js', ['lib/utilities/assert.js', 'lib/utilities/configuration.js', 'lib/logging/console_channel.js', 'lib/utilities/object.js'], function (_export) {
   /**
    * Copyright 2015 aixigo AG
    * Released under the MIT license.
    * http://laxarjs.org/license
   ...
   var assert, configuration, consoleChannel, object, slice, level, CHROME_STACK_MATCHER, FIRE_FOX_STACK_MATCHER, EMPTY_CALL_INFORMATION;
   ...
   return {
      setters: [function (_libUtilitiesAssertJs) {
         ...
         configuration = _libUtilitiesConfigurationJs;
      }, function (_libLoggingConsole_channelJs) {
         consoleChannel = _libLoggingConsole_channelJs.log;
      }, function (_libUtilitiesObjectJs) {
         object = _libUtilitiesObjectJs;
      }],
      execute: function () {
         ...
         CHROME_STACK_MATCHER = /\(?([^\( ]+\.js)\:(\d+)\:(\d+)\)?$/;
         FIRE_FOX_STACK_MATCHER = /@(.+)\:(\d+)$/;
         EMPTY_CALL_INFORMATION = { file: '?', line: -1, char: -1 };
...
System.register('laxar', ['npm:babel-runtime@5.8.34/core-js/object/keys', 'npm:angular@1.4.8', 'lib/logging/log.js', 'lib/directives/directives.js', 'lib/event_bus/event_bus.js', 'lib/file_resource_provider/file_resource_provider.js', 'lib/i18n/i18n.js', 'lib/loaders/widget_loader.js', 'lib/utilities/assert.js', 'lib/utilities/configuration.js', 'lib/utilities/fn.js', 'lib/utilities/object.js', 'lib/utilities/path.js', 'lib/utilities/storage.js', 'lib/utilities/string.js', 'lib/runtime/runtime.js', 'lib/runtime/runtime_dependencies.js', 'lib/runtime/controls_service.js', 'lib/runtime/theme_manager.js', 'lib/widget_adapters/adapters.js'], function (_export) {
   var _Object$keys, ng, log, directives, eventBus, fileResourceProvider, i18n, widgetLoader, assert, configuration, fn, object, path, storage, string, runtime, runtimeDependencies, controlsService, themeManager, adapters, _tooling;
   ...
   function bootstrap(widgetModules, optionalWidgetAdapters) {
      ...
      _Object$keys(widgetModules).forEach(function (technology) {
   ...
   return {
      setters: [function (_npmBabelRuntime5834CoreJsObjectKeys) {
         ...
         configuration = _libUtilitiesConfigurationJs;
      }, function (_libUtilitiesFnJs) {
         fn = _libUtilitiesFnJs['default'];
      }, function (_libUtilitiesObjectJs) {
         object = _libUtilitiesObjectJs;
      }, function (_libUtilitiesPathJs) {
         path = _libUtilitiesPathJs;
         ...
         string = _libUtilitiesStringJs;
      }, function (_libRuntimeRuntimeJs) {
         runtime = _libRuntimeRuntimeJs['default'];
      }, function (_libRuntimeRuntime_dependenciesJs) {
         runtimeDependencies = _libRuntimeRuntime_dependenciesJs;
      }, function (_libRuntimeControls_serviceJs) {
         controlsService = _libRuntimeControls_serviceJs;
      }, function (_libRuntimeTheme_managerJs) {
         themeManager = _libRuntimeTheme_managerJs;
