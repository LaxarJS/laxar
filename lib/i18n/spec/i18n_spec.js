...
describe( 'An internationalization package ', () => {
   ...
   beforeEach( () => {
      ...
      configByPath = {
         'i18n.fallback': CONFIGURED_FALLBACK
      };
      ...
      i18n = createI18n( createConfigurationMock( configByPath ) );
   } );
   ...
   describe( 'when asked for a relaxed localization (localizeRelaxed)', () => {
      ...
      it( 'should return undefined when the requested localization is missing, without fallback', () => {
