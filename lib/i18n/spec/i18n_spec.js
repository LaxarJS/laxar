   ...
   describe( 'An internationalization package ', function() {
      ...
      describe( 'when asked for a localization (localize)', function() {
         ...
         it( 'should return undefined when the requested localization is missing', function() {
            ...
            expect( i18n.localize( 'en_GB', i18nValue ) ).toBeUndefined();
         ...
         it( 'should be case-insensitive when processing languageTags', function() {
            ...
            expect( i18n.localize( 'de-DE',  { 'de': Error, 'de_DE_etc': Error } ) ).toBeUndefined();
         } );
      ...
      describe( 'when asked for a relaxed localization (localizeRelaxed)', function() {
         ...
         it( 'should access the fallback locale as needed', function() {
            expect( i18n.localizeRelaxed( 'XYZ', i18nValue ) ).toEqual( 'A value' );
         } );
      ...
      describe( 'when asked for a partially applied localization (localizer)', function() {
         ...
         it( 'returns an empty string when asked to format based on a non-string localized value', function() {
            function tester( localizer, i18nFormat, arg1, arg2 ) {
               return function() { localizer.format( i18nFormat, arg1, arg2 ); };
            }
            ...
            var enGb = i18n.localizer( 'en_GB' );
            expect( tester( enGb, i18nInvalidFormat, 'Giles', 'a value' ) ).toThrow();
            var de = i18n.localizer( 'de' );
            expect( tester( de, i18nInvalidFormat, 'Peter', 'ein Wert' ) ).toThrow();
            var deCh = i18n.localizer( 'de_CH' );
            expect( tester( deCh, i18nInvalidFormat, 'Hans', 'ein Wert' ) ).toThrow();
         } );
