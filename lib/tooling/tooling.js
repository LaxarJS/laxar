...
export function create( debugEventBus, configuration, log ) {
   ...
   addPagesTooling( api, configuration.get( 'tooling.enabled' ) );
 ...
 *    whether to enable the pages tooling or not
 * @private
 */
function addPagesTooling( api, enable ) {
   let pagesTooling;
