...
describe( 'The page tooling provider', () => {
   ...
   beforeEach( () => {
      ...
      const configurationMock = createConfigurationMock( { 'tooling.enabled': true } );
      const logMock = createLogMock();
      const tooling = createTooling( debugEventBus, configurationMock, logMock );
      ...
      debugEventBus.publish( 'didLoad.widget.inst-id0.item-id1', { widget: 'w' } );
