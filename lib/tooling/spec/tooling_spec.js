...
define( [
   ...
   describe( 'The external tooling API', function() {
      ...
      describe( 'with tooling enabled by configuration', function() {
      ...
      describe( 'with tooling not explicitly enabled by configuration', function() {
         ...
         describe( 'even when \'window.laxarDeveloperToolsExtensionLoaded\' is true', function() {
            var globalEventBus;
            ...
            it( 'does not provide the external API', function() {
               expect( window.laxarDeveloperToolsApi ).not.toBeDefined();
            } );
         ...
         describe( 'even when the body has \'data-laxar-developer-tools-extension\'', function() {
            var globalEventBus;
