...
describe( 'The page tooling provider', () => {
   ...
   beforeEach( () => {
      ...
      debugEventBus.publish( 'didLoad.page.test-id0', { page: 'p' } );
      debugEventBus.flush();
   } );
   ...
   describe( 'with registered listeners', () => {
      ...
      beforeEach( () => {
         ...
         debugEventBus.publish( 'didUnload.page.test-id0', { page: 'p' } );
         debugEventBus.publish( 'didLoad.page.test-id0', { page: 'q' } );
         debugEventBus.flush();
      } );
