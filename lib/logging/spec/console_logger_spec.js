...
define( [
   ...
   describe( 'A console logger', function() {
      ...
      beforeEach( function() {
         ...
         logger_.addLogChannel( consoleLogger );
      } );
      ...
      describe( 'when console.log is available', function() {
         ...
         it( 'will use the appropriate console method if it exists', function() {
            window.console.statistics = jasmine.createSpy( 'console.statistics' );

            logger_.statistics( 'Open file handles: 2001' );

            expect( window.console.log ).not.toHaveBeenCalled();
            expect( window.console.statistics ).toHaveBeenCalled();
         } );
      ...
      describe( 'processes the message object and', function() {
         ...
         beforeEach( function() {
            ...
            logger_.error( 'this [0] is a [1] [0]. Data: [2]!', 'situation', 'bad', { cars: 10 } );
         ...
         it( 'splits the message at the replacement marks and inserts the replacement value at the position for the argument list', function() {
            logArgs.shift();
            logArgs.pop();
