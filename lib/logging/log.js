...
define( [
   ...
   function Logger() {
      ...
      this.counter_ = 0;
      this.messageQueue_ = [];
      this.threshold_ = configuration.get( 'logging.threshold', 0 );
      this.tags_ = {};
      ...
      var self = this;
      self.levelToName_ = {};
      object.forEach( this.level, function( level, levelName ) {
         self.levelToName_[ level ] = levelName;

         self[ levelName.toLowerCase() ] = function() {
