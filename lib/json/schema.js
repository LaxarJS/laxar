   ...
   function transformV3V4Recursively( schema, parentKey, parentSchema, originalParentSchema ) {
      ...
      Object.keys( schema ).forEach( function( key ) {
         ...
         switch( key ) {
            ...
            case 'items':
               resultingSchema[ key ] = transformV3V4Recursively( schema[ key ], key, resultingSchema, schema );
               break;
            ...
            case 'additionalProperties':
               if( typeof schema[ key ] === 'object' ) {
                  ...
                  resultingSchema[ key ] = schema[ key ];
               }
               break;

            case 'properties':
            case 'patternProperties':
               resultingSchema[ key ] = object.map( schema[ key ], function( patternSchema, pattern ) {
                  return [ pattern, transformV3V4Recursively( patternSchema, pattern, resultingSchema, schema ) ];
               } );
               break;
