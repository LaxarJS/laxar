...
define( [
   ...
   describe( 'Text', function() {
      ...
      describe( 'format( String formatString, [...] )', function() {
         ...
         // (#43) disabled as the new format function doesn't throw an exception in this case
         xit( 'throws an error if a positional placeholder references a non-existing argument', function() {
         ...
         // (#43) disabled as the new format function doesn't support custom formatting this way
         xit( 'formats any object using its getFormatter() method if it has one', function() {
            var object = {
         ...
         // (#43) disabled as the new format function doesn't support custom formatting this way
         xit( 'passes the actual format part of the format string to the object\'s formatter', function() {
            var object = {
               'getFormatter' : function() {
                  return {
         ...
         // (#43) disabled as the new format function doesn't support custom formatting this way
         xit( 'chooses the object\'s formatter over its toString() method if both exist', function() {
            var object = {
               'getFormatter' : function() {
                  return {
                     'toString': function() {
         ...
         // (#43) disabled as the new format function doesn't support custom formatting this way
         xit( 'throws an error if a format is used that is not understood by the standard formatters', function() {
            var test = function() {
         ...
         // (#43) disabled as the new format function doesn't support string padding
         xit( 'pads strings with leading spaces if the value is shorter than the requested length', function() {
         ...
         // (#43) disabled as the new format function doesn't support string shortening
         xit( 'cuts off strings at the right side if the value is longer than the requested length', function() {
         ...
         // (#43) disabled as the new format function doesn't support ... this
         xit( 'can resolve named arguments by their positional index', function() {
