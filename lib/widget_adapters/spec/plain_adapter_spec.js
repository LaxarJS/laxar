...
describe( 'A plain widget adapter module', () => {
   ...
   it( 'provides a bootstrap method for context instantiation', () => {
      ...
      expect( plainAdapterModule.bootstrap( [], services_ ) ).toBeDefined();
   } );
   ...
   describe( 'when bootstrapped', () => {
      ...
      beforeEach( () => {
         factory = plainAdapterModule.bootstrap( [], services_ );
      } );
      ...
      it( 'allows to create an adapter factory from dependencies', () => {
         let adapter = null;
         expect( () => { adapter = factory.create( environment_ ); } ).not.toThrow();
...
describe( 'A plain widget adapter', () => {
   ...
   beforeEach( () => {
      ...
      const factory = plainAdapterModule.bootstrap( [ testWidgetModule_ ], services_ );
      adapter_ = factory.create( environment_ );
   } );
