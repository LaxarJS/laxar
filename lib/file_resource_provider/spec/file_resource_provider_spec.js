 ...
 */
import { init as initFrp, create as createFrp } from '../file_resource_provider';
import * as q from 'q';
...
describe( 'A FileResourceProvider', () => {
   ...
   beforeEach( () => {
      ...
      initFrp( q, httpClient );

      fileResourceProvider_ = createFrp( '/' );
         ...
         fileResourceProvider_.isAvailable( '/myFiles/myFile.json' )
            .then( found => {
               ...
               expect( httpClient.get )
                  .toHaveBeenCalledWith( '/var/listing/myFiles.json', jasmine.any( Object ) );
   ...
   describe( 'for a root path with parent references', () => {
      ...
      beforeEach( () => {
         ...
         fileResourceProvider_ = createFrp( 'http://domain:8000/includes/..' );
   ...
   describe( 'with embedded contents', () => {
      ...
      beforeEach( () => {
         ...
         spyOn( configuration, 'get' ).and.callFake( ( key, fallback ) => {
