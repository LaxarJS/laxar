...
describe( 'A meta object', () => {
   ...
   describe( 'has an unsubscribe function', () => {
      ...
      it( 'that provides a way to directly unsubscribe the called subscriber from further events', () => {
         expect( calls ).toEqual( 1 );
      } );

      ////////////////////////////////////////////////////////////////////////////////////////////////////////

      it( 'that logs a deprecation warning', () => {
         expect( logMock.warn )
...
describe( 'EventBus unsubscribing', () => {
   ...
   it( 'logs a deprecation warning when EventBus.unsubscribe is called', () => {
      eventBus.unsubscribe( subscriberSpy );
      expect( logMock.warn )
         .toHaveBeenCalledWith(
   ...
   it( 'allows unsubscribing by using the function returned by subscribe', done => {
      unsubscribeFunctions.forEach( _ => { _(); } );
