   ...
   describe( 'include a set of useful information that', () => {
      ...
      it( 'contains a human readable error message', () => {
         expect( errorInformation[ 0 ] ).toEqual(
            'error while calling subscriber "meThrowsError" for event myEvent published by "itsMe!" ' +
...
describe( 'An event bus can have a mediator that', () => {
   ...
   it( 'is called before calling subscribers with currently queued event items in publish-order', done => {
