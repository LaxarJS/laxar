...
import { create as createPagesTooling } from '../tooling/pages';
...
export function create(
   ...
   return {
      forWidget( specification, widgetConfiguration, features, decorators = {}, instanceContext = null ) {
         ...
         registerServiceFactory(
            'axTooling',
            () => createToolingForWidget( tooling, widgetId, instanceContext )
         );
         registerServiceFactory(
            'axVisibility',
   ...
   function createToolingForWidget( tooling, widgetId, instanceContext ) {
      return {
         ...tooling,
         pages: createPagesTooling( tooling, instanceContext )
      };
   }
