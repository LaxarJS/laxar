      ...
      function setupPage( pageName ) {
         ...
         return pageLoader.load( pageName )
            ...
            .then( widgetAdapterWrappers => {
               debugEventBus.publish( `didLoad.page.${instanceContext.instance}.${instanceContext.id}`, {
                  ...instanceContext,
                  page: pageName
               } );
      ...
      function tearDownPage() {
         ...
         return eventBus
            ...
            .then( () => {
               ...
               debugEventBus.publish( `didUnload.page.${instanceContext.instance}.${instanceContext.id}`, {
                  ...instanceContext,
                  page: pageName
               } );
               cleanUpLayout();
