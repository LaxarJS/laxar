 ...
 * @injection
 */
module.factory( 'axHeartbeat', [ 'axServices', services => services.heartbeat ] );
 ...
 * @injection
 */
module.factory( 'axControls', [ 'axServices', services => services.controls ] );
 ...
 * @injection
 */
module.factory( 'axGlobalEventBus', [ 'axServices', services => services.globalEventBus ] );
 ...
 * @injection
 */
module.factory( 'axConfiguration', [ 'axServices', services => services.configuration ] );
 ...
 * @injection
 */
module.factory( 'axFileResourceProvider', [ 'axServices', services => services.fileResourceProvider ]);
 ...
 * @injection
 */
module.factory( 'axThemeManager', [ 'axServices', services => services.themeManager ] );
 ...
 * @injection
 */
module.factory( 'axLayoutLoader', [ 'axServices', services => services.layoutLoader ] );
 ...
 * @injection
 */
module.factory( 'axCssLoader', [ 'axServices', services => services.cssLoader ] );
