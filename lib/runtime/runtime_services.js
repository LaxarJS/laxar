...
define( [
   ...
   var module = ng.module( 'axPortalServices', [] );
   ...
   module.factory( 'axThemeManager', [
      '$q', 'axConfiguration', 'axFileResourceProvider', 'axGlobalEventBus',
         ...
         eventBus.subscribe( 'changeThemeRequest', function( event ) {
            eventBus
               ...
               .then( function() {
                  ...
                  // didChangeTheme event is sent by the AxFlowController after each beginLifecycleRequest event.
               } );
