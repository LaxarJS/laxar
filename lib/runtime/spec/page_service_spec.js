   ...
   describe( 'provides a page controller that', () => {
      ...
      describe( 'when asked to setup a page', () => {
         ...
         it( 'automatically adds only missing default widget areas', () => {
            ...
            expect( activitiesArea.getAttribute( 'data-ax-widget-area' ) ).toEqual( 'activities' );
            expect( activitiesArea.style.display ).toEqual( 'none' );
            expect( popoversArea.nodeName.toLowerCase() ).toEqual( 'div' );
            expect( popoversArea.getAttribute( 'data-ax-widget-area' ) ).toEqual( 'popovers' );
            expect( empty ).not.toBeDefined();

            expect( areaHelper.register ).toHaveBeenCalledWith( 'activities', activitiesArea, 'activities' );
            expect( areaHelper.register ).toHaveBeenCalledWith( 'popovers', popoversArea, 'popovers' );
         } );
