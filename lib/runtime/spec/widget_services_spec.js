      ...
      describe( 'axEventBus', () => {
         ...
         describe( 'and when releasing the services again', () => {
            ...
            beforeEach( () => {
               mockSubscriber = () => {};
               mockSubscriber2 = () => {};
               axEventBus.subscribe( 'something', mockSubscriber );
               axEventBus.subscribe( 'something', mockSubscriber2 );
            ...
            it( 'unsubscribes event bus subscriptions', () => {
               expect( axGlobalEventBus.unsubscribe ).toHaveBeenCalledWith( mockSubscriber );
               expect( axGlobalEventBus.unsubscribe ).toHaveBeenCalledWith( mockSubscriber2 );
            } );
