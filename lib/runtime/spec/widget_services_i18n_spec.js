...
describe( 'axI18n', () => {
   ...
   describe( 'created for a widget context with i18n feature ("default" locale)', () => {
      ...
      beforeEach( () => {
         axI18n = createWidgetServicesI18n( context, { fallback: CONFIGURED_FALLBACK } );
   ...
   describe( 'created for a widget context, with *strict* localization', () => {
      ...
      beforeEach( () => {
         axI18n = createWidgetServicesI18n( context, { strict: true } );
         mockPublishTag( 'de' );
   ...
   describe( 'created for a widget context, with *relaxed* localization', () => {
      ...
      beforeEach( () => {
         axI18n = createWidgetServicesI18n( context, { strict: false, fallback: CONFIGURED_FALLBACK } );
         mockPublishTag( 'de_DE' );
         mockPublishTag( 'en', 'alternative' );
      } );
