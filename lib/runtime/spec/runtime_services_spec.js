...
describe( 'The axControls factory', () => {
   ...
   describe( 'asked to provide a control implementation module', () => {
      ...
      beforeEach( done => {
         ...
         System.import( './mocks/control_mock' )
            ...
            .then( () => {
               ...
               spyOn( path, 'join' ).and.returnValue( './mocks/control_mock' );
...
describe( 'An axLogHttpInterceptor', () => {
   ...
   function configure( loggingHttpHeader ) {
      ...
      spyOn( configuration, 'get' )
         .and.callFake( key => key === 'logging.http.header' ? loggingHttpHeader : origGet_( key ) );
