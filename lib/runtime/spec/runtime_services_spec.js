...
define( [
   ...
   '../../utilities/object'
], function( runtimeServicesModule, configuration, angularMocks, log, fileResourceProvider, jqueryMock, portalMocks, object ) {
   'use strict';
   ...
   describe( 'The axThemeManager-factory', function() {
      ...
      beforeEach( angularMocks.inject( function( $timeout, $rootScope, axGlobalEventBus, axConfiguration ) {
         ...
         angularMocks.inject( function( axThemeManager ) {
