...
describe( 'A flow controller instance', () => {
   ...
   it( 'validates the flow data to load', done => {
   ...
   describe( 'when the flow is loaded', () => {
      ...
      it( 'loads the place for the currently resolved route', () => {
         const place = flowController.placeForTarget( flowControllerModule.TARGET_SELF );
         expect( place.id ).toEqual( 'editor' );
      } );
      ...
      describe( 'on navigate request to same target with different parameters', () => {
         ...
         it( 'sends a willNavigate event to indicate end of navigation', () => {
         ...
         it( 'keeps the same place as before', () => {
            expect( flowController.placeForTarget( '_self' ).id ).toEqual( 'editor' );
         } );
      ...
      describe( 'on navigate request to a different target', () => {
         ...
         it( 'changes the active place to the requested target\'s place to', () => {
            expect( flowController.placeForTarget( '_self' ).id ).toEqual( 'welcome' );
         } );
