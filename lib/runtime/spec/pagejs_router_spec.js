...
describe( 'A page.js router', () => {
   ...
   describe( 'initialized with a map of routes', () => {
      ...
      describe( 'using hash based routing', () => {

         overrideConfig( 'router.base', '/path-base' );
         overrideConfig( 'router.pagejs.hashbang', true );

         describe( 'asked to navigate based on patterns ', () => {

            beforeEach( () => {
               router.navigateTo( [ '/hashPrefix' ], {} );
            } );

            //////////////////////////////////////////////////////////////////////////////////////////////////

            it( 'triggers page.js with the path prefixed by the base (#430)', () => {
               expect( pagejsMock.page.show ).toHaveBeenCalledWith( '/path-base#!/hashPrefix' );
            } );
         ...
         describe( 'asked to navigate based on a path ', () => {

            beforeEach( () => {
               router.navigateToPath( '/hashPrefix' );
            } );
