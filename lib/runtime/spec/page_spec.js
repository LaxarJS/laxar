...
define( [
   ...
   describe( 'The axPage module', function() {
      ...
      beforeEach( function() {
         ...
         spyOn( layoutWidgetAdapter, 'create' ).andCallThrough();
      ...
      describe( 'defines a page directive with controller', function() {
         ...
         beforeEach( ngMocks.inject( function( _$rootScope_, $compile, $controller ) {
         ...
         describe( 'that when asked to load a page', function() {
            ...
            describe( 'and ticking', function() {
               ...
               it( 'creates a layout widget adapter for embedded layouts (#193)', function() {
