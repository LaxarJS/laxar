 ...
 */
export function bootstrap( artifacts, { artifactProvider, adapterUtilities } ) {
    ...
    */
   function create( { widgetName, anchorElement, services, provideServices, pageElement } ) {
      ...
      return Promise.all( [ provider.descriptor(), provider.module() ] )
         .then( createController, () => adapterUtilities.unknownWidget( { technology, widgetName } ) )
         .then( () => ( {
               domAttachTo,
               domDetach
            } ) );
