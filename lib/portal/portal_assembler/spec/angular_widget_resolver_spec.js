...
define( [
...
], function( angularWidgetResolver, fileResourceProvider, portalMocks, path, themeManager, paths, specData ) {
   'use strict';

   var pathToProduct = path.normalize( paths.PRODUCT );
   var pathToWidgets = path.normalize( paths.WIDGETS );
   var pathToThemes = path.normalize( paths.THEMES );
   ...
   describe( 'An initialized angular widget resolver', function() {
      ...
      beforeEach( function() {
         ...
         http_.respondWith( 'GET', pathToProduct + '/var/listing/testing_widgets.json', specData );

         fileResourceProvider.init( q_, http_ );
         fileResourceProvider_ = fileResourceProvider.create( pathToProduct + '/' );
         fileResourceProvider_.setFileListingUri( '', 'var/listing/testing_widgets.json' );
      ...
      describe( 'when asked to resolve a widget using the default theme', function() {
         ...
         it( 'correctly resolves it', function() {
            expect( promiseSpy ).toHaveBeenCalledWith( {
               specification: {},
               includeUrl: pathToWidgets + '/portal/super_default_widget/default.theme/super_default_widget.html',
               controllerName: 'widgets.portal.super_default_widget.Controller',
               cssFileUrls: [ pathToWidgets + '/portal/super_default_widget/default.theme/css/super_default_widget.css' ]
            } );
         } );
      ...
      describe( 'when asked to resolve a widget using the green theme', function() {
         ...
         it( 'correctly resolves it', function() {
            expect( resolveSpy ).toHaveBeenCalledWith( {
               specification: {},
               includeUrl: pathToThemes + '/green.theme/widgets/portal/super_green_widget/super_green_widget.html',
               controllerName: 'widgets.portal.super_green_widget.Controller',
               cssFileUrls: [ pathToThemes + '/green.theme/widgets/portal/super_green_widget/css/super_green_widget.css' ]
            } );
         } );
      ...
      describe( 'when asked to resolve a widget that is only partly themed', function() {
         ...
         it( 'uses missing parts from the default theme', function() {
            expect( promiseSpy ).toHaveBeenCalledWith( {
               specification: {},
               includeUrl: pathToWidgets + '/portal/mixed_widget/default.theme/mixed_widget.html',
               controllerName: 'widgets.portal.mixed_widget.Controller',
               cssFileUrls: [ pathToThemes + '/green.theme/widgets/portal/mixed_widget/css/mixed_widget.css' ]
            } );
         } );
