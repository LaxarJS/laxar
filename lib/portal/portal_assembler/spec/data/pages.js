...
define( [], {
   ...
   derivedPageWithMixins: {
      'extends': 'basePageForPageWithMixins',
   ...
   derivedPageWithMixinsAndInsertBeforeId: {
      'extends': 'basePageForPageWithMixins',
