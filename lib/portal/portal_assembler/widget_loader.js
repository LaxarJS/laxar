...
define( [
    ...
    */
   function create( q, fileResourceProvider, themeManager, cssLoader, eventBus, configuration ) {
         ...
         return promise
            .then( function( specification ) {
               ...
               var adapter = adapters[ technology ].create(
                  assetResolver, specification, features, widgetConfiguration, anchorElement
               );
