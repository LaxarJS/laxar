...
define( [
   ...
   module.controller( PAGE_CONTROLLER_NAME, [
      '$scope', PAGE_SERVICE_NAME, 'axVisibilityService', '$q', 'Configuration', 'CssLoader', 'LayoutLoader', 'EventBus', 'FileResourceProvider', 'ThemeManager', '$timeout',
      function( $scope, pageService, visibilityService, $q, configuration, cssLoader, layoutLoader, eventBus, fileResourceProvider, themeManager, $timeout ) {
