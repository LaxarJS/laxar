...
define( [
   ...
   /**
    * Sets a mew theme and stores it in the browser's session storage. This method should only ever be called
    * by the portal. The correct way to change the theme for the application is via the `changeThemeRequest`
    * event.
    *
    * @param {String} theme
    *    the theme to set
    ...
    * fallback. The `provide` method of the returned object can be called with a list of files a themed for
    * which a themed version should be found. The most specific theme is searched for first and the default
    * theme afterwards.
    *
