   ...
   describe( 'A flow module', function() {
      ...
      describe( 'when bootstrapped', function() {
         ...
         it( 'loads the flow data', angularMocks.inject( function( $route ) {
            ...
            $httpBackend.expectGET( testData.urls.step1 ).respond( asFileResource( testData.pages.step1 ) );
            $httpBackend.expectGET( testData.urls.step2 ).respond( asFileResource( testData.pages.step2 ) );
            $httpBackend.expectGET( testData.urls.step3 ).respond( asFileResource( testData.pages.step3 ) );
         ...
         describe( 'when the flow data was loaded', function() {
            ...
            beforeEach( angularMocks.inject( function( _$route_ ) {
               ...
               $httpBackend.whenGET( testData.urls.step1 ).respond( asFileResource( testData.pages.step1 ) );
               $httpBackend.whenGET( testData.urls.step2 ).respond( asFileResource( testData.pages.step2 ) );
               $httpBackend.whenGET( testData.urls.step3 ).respond( asFileResource( testData.pages.step3 ) );
