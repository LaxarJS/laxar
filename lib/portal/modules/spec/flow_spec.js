...
define( [
   ...
   describe( 'A flow module', function() {
      ...
      describe( 'when bootstrapped', function() {
         ...
         beforeEach( angularMocks.inject( function( _$injector_, _$route_ ) {
         ...
         function invokeRunBlock() {
            angularMocks.inject( function( $rootScope ) {
               $httpBackend.whenGET( testData.urls.flow ).respond( asFileResource( testData.flow ) );
         ...
         function simulateNavigationTo( placeName, parameters ) {
            angularMocks.inject( function( $controller ) {
         ...
         describe( 'defines a controller', function() {
            ...
            describe( 'that on further navigation', function() {
               ...
               beforeEach( angularMocks.inject( function( _$location_ ) {
         ...
         describe( 'defines a flow service', function() {
            ...
            beforeEach( function() {
               ...
               angularMocks.inject( function( axFlowService ) {
