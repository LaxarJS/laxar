...
define( [
   ...
   module.controller( 'portal.FlowController', [
      '$window', '$location', '$routeParams', '$rootScope', 'place', 'EventBus', 'axFlowService', 'axPageService',

      function FlowController( $window, $location, $routeParams, $rootScope, place, eventBus, flowService, pageService ) {
         ...
         activePlace_ = place;
         // for backwards compatibility. Will be removed from v1.0.0 onwards
   ...
   function assembleRoute( routeName, place ) {
      ...
      if( !place.page && !place.exitFunction ) {
