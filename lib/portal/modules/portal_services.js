...
define( [
   ...
   var globalEventBusFactory = [
      '$injector', '$window', 'axHeartbeat', 'Configuration',
      function( $injector, $window, heartbeat, configuration ) {
         ...
         var bus = eventBus.create( {
            pendingDidTimeout: configuration.get( 'event_bus.timeout_ms', 120*1000 )
         } );
         bus.setErrorHandler( eventBusErrorHandler );

         return bus;
   } ];
   module.factory( 'EventBus', globalEventBusFactory );
   // Forward compatibility with LaxarJS 1.x (#160)
   module.factory( 'axGlobalEventBus', globalEventBusFactory );

   ///////////////////////////////////////////////////////////////////////////////////////////////////////////

   var configurationFactory = [ function() { return configuration; } ];
   module.factory( 'Configuration', configurationFactory );
   // Forward compatibility with LaxarJS 1.x (#160)
   module.factory( 'axConfiguration', configurationFactory );

   ///////////////////////////////////////////////////////////////////////////////////////////////////////////

   var i18nFactory = [ function() { return i18n; } ];
   module.factory( 'i18n', i18nFactory );
   // Forward compatibility with LaxarJS 1.x (#160)
   module.factory( 'axI18n', i18nFactory );
   ...
   module.factory( 'axLogHttpInterceptor', [ 'Configuration', function( configuration ) {
      var headerKey = configuration.get( CONFIG_KEY_HTTP_LOGGING_HEADER, null );
      return headerKey ? {
         request: function( config ) {
            var headerValue = '';
            ng.forEach( log.context.gatherTags(), function( tagValue, tagName ) {
