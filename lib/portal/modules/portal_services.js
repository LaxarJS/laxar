...
define( [
   ...
   module.factory( 'EventBus', [
      '$injector', '$window', '$rootScope', '$timeout',
      function( $injector, $window, $rootScope, $timeout ) {
         ...
         function nextTick( f ) {
            if( !ticking ) {
               ...
               $window.setTimeout( function() {
                  ...
                  // These occur mostly because promises from publishAndGatherReplies use AngularJS $q.
                  do {
         ...
         eventBus.init( $q, nextTick, $timeout );
