 ...
 */
import { create as createValidator } from '../json_validator';
import jjv from 'jjv';
...
describe( 'A JsonValidator', () => {
   ...
   describe( 'when asked to prohibit additional properties', () => {
      ...
      it( 'adds the respective property to the schema where applicable', () => {
         ...
         expect( schema.properties.patternAndSimpleProps.additionalProperties ).toBe( false );
      } );
