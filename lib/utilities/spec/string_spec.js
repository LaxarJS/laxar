...
define( [
   ...
   describe( 'String utilities', function() {
      ...
      describe( 'format( String[, Array][, Object] )', function() {
         ...
         it( 'returns non string arguments untouched', function() {
            expect( string.format( null ) ).toBe( null );
            expect( string.format( 123 ) ).toBe( 123 );
            expect( string.format( false ) ).toBe( false );
            expect( string.format( { a: 12 }  ) ).toEqual( { a: 12 } );
         } );
