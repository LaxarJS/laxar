...
describe( 'String utilities', () => {
   ...
   describe( 'format( String[, Array][, Object] )', () => {
      ...
      it( 'replaces all existing named placeholders in a string keeping placeholders without values', () => {
      ...
      it( 'replaces all existing placeholders in a string keeping placeholders without values', () => {
