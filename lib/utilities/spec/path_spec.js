...
describe( 'Path utilities', () => {
   ...
   describe( 'join( pathfragment [, pathfragment ]* )', () => {
      ...
      it( 'throws an error for non-string arguments', () => {
         expect( () => { path.join( {} ); } )
            .toThrow( new Error( 'Assertion error: Expected value to be an instance of "String" but was "Object".' ) );
         expect( () => { path.join( true ); } )
            .toThrow( new Error( 'Assertion error: Expected value to be an instance of "String" but was "Boolean".' ) );
         expect( () => { path.join( '', 9 ); } )
