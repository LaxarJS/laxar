...
define( [
   ...
   function createAngularModule( modelWatchSpy, controllerSpy, injections ) {

      Controller.$inject = injections || [ '$scope', '$q' ];
      function Controller() {
         if( controllerSpy ) {
      ...
      angular
         ...
         .controller( 'magic.fantasy_widget.Controller', Controller );
   }
