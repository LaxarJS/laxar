...
define( [
   ...
   describe( 'PortalMocks mockTimestamp', function() {

      var mockTimestamp_;

      beforeEach( function() {
         jasmine.Clock.useMock();
         mockTimestamp_ = portalMocks.mockTimestamp;
      } );

      ////////////////////////////////////////////////////////////////////////////////////////////////////////

      it( 'provides a timestamp based on the jasmine mock clock', function() {
         var t0 = mockTimestamp_();
         jasmine.Clock.tick( 10 );
         var t1 = mockTimestamp_();
         expect( t1 ).toEqual( t0 + 10 );
      } );
