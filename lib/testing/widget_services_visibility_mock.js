...
export function create( context ) {
   ...
   const areaHelperMock = createWidgetServicesAreaHelperMock( context );
    ...
    * @extends AxMock
    */
   const visibility = createWidgetServicesVisibility( context, areaHelperMock );
   Object.keys( visibility ).forEach( method => {
      if( [ 'updateAreaVisibility', 'updateWidgetVisibility' ].includes( method ) ) {
         ...
         spyOn( visibility, method ).and.callFake( () => mockStatus );
      }
      else {
