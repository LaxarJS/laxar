      ...
      function create( q, fileResourceProvider, specification, features, widgetConfiguration, anchorElement ) {
         ...
         if( !testBed._moduleCreated ) {
            angularMocks.module( testBed.moduleName, function( _$provide_ ) {
               $provide = _$provide_;
               var globalEventBusFactoryMock = function() { return testBed.eventBusMock; };
               $provide.service( 'EventBus', globalEventBusFactoryMock );
               // Forward compatibility with LaxarJS 1.x (#160)
               $provide.service( 'axGlobalEventBus', globalEventBusFactoryMock );
            } );
