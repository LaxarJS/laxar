...
define( [
   ...
   function createEventBusForWidget( eventBus, widget ) {
      ...
      function transformEvent( optionalEvent ) {
      ...
      var bus = {
         setInspector: forward( 'setInspector' ),
         ...
         publish: function( eventName, optionalEvent, optionalOptions ) {
            return eventBus.publish( eventName, transformEvent( optionalEvent ), optionalOptions );
         },
         publishAndGatherReplies: function( eventName, optionalEvent, optionalOptions ) {
            return eventBus.publishAndGatherReplies( eventName, transformEvent( optionalEvent ), optionalOptions );
         }
      };
