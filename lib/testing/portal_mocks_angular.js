...
define( [
   ...
   './portal_mocks'
], function( $, angularMocks, fn, object, string, eventBusModule, log, consoleChannel, adapters, widgetLoaderModule, themeManager, portalMocks ) {
   'use strict';
   ...
   function portalMocksAngularAdapter( testBed ) {
      ...
      function create( environment ) {
         ...
         function createController() {
            ...
            scope.widget = {
               area: environment.context.widget.area,
