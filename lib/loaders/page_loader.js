...
define( [
   ...
   function loadPageRecursively( self, pageName, extensionChain ) {
      ...
      return load( self, pageSelfLink )
         ...
         .then( function() {
            checkForDuplicateIds( self, page );
            removeDisableWidgets( self, page );
         } )
         .then( function() {
   ...
   function removeDisableWidgets( self, page ) {
   ...
   function generateDefaultWidgetSpecName( widgetSpec ) {
      if( widgetSpec.hasOwnProperty( 'widget' ) ) {
         ...
         return widgetName.replace( SEGMENTS_MATCHER, dashToCamelcase );
      }
      if( widgetSpec.hasOwnProperty( 'composition' ) ) {
         return widgetSpec.composition.replace( SEGMENTS_MATCHER, dashToCamelcase );
      }
      // FIXME what about new cases?
   }
