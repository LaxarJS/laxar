   ...
   describe( 'A features-provider', function() {
      ...
      describe( 'can determine the current set of features for a widget instance', function() {
         ...
         it( 'where missing required features lead to an error', function() {
            ...
            } ).toThrow( 'Problem: Validation of feature-configuration failed. Errors: ' +
         ...
         it( 'when features are specified as v4 and top-level defaults need to be inferred', function() {
            var v4Spec = {
               features: {
                  $schema: 'http://json-schema.org/draft-04/schema#',
                  type: 'object',
