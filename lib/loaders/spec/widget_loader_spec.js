...
describe( 'An initialized widgetLoader', () => {
   ...
   beforeEach( () => {
      ...
      const fileResources = {
         ...
         'the_widgets/test/test_widget/default.theme/test-widget.html': widgetData.htmlTemplate,
         'the_widgets/test/test_widget/default.theme/css/test-widget.css': 1,
   ...
   describe( 'when creating a widget adapter', () => {
      ...
      it( 'creates the services for the widget', () => {
         expect( widgetServicesFactoryMock ).toHaveBeenCalledWith(
            widgetSpecification, widgetConfiguration, { myFeature: { myProp: 'x' } }, {}
         );
      } );
      ...
      it( 'correctly resolves CSS assets for widgets', () => {
         expect( cssLoader.load ).toHaveBeenCalledWith(
            'the_widgets/test/test_widget/default.theme/css/test-widget.css'
         );
      } );

      ////////////////////////////////////////////////////////////////////////////////////////////////////////

      it( 'correctly resolves CSS assets for controls', () => {
         expect( cssLoader.load ).toHaveBeenCalledWith(
