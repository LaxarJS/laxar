 ...
 * @param {ControlsLoader} controlsLoader
...
export function create(
   ...
   return {
       ...
       *
       * @param {WidgetAdapter[]} adapters
       *    a list of widget adapters to be registered with this loader
       *
       * @memberof WidgetLoader
       */
   ...
   function load( widgetConfiguration, { onBeforeControllerCreation = noOp } = {} ) {
      ...
      return widgetArtifactProvider
         ...
         .then( descriptor => {
            ...
            const adapter = { destroy: noOp, ...adapterFactory.create( environment ) };
