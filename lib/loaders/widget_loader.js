...
export function create(
    ...
    * @param {Object} [instanceContext]
    *    an object identifying the bootstrapping item and laxar instance the widget lives in
    *
    * @return {Promise} a promise for a widget adapter, with an already instantiated controller
    *
    * @memberof WidgetLoader
    */
   function load( widgetConfiguration, { whenServicesAvailable = noOp } = {}, instanceContext = {} ) {
