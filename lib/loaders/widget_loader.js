...
export function create(
   ...
   function load(
      widgetConfiguration,
      { whenServicesAvailable = noOp, anchorElement = null } = {},
      itemMeta = {}
   ) {
      ...
      return widgetArtifactProvider
         ...
         .then( descriptor => {
            ...
            environment.anchorElement.className = widgetName;
            environment.anchorElement.id = `ax${ID_SEPARATOR}${widgetConfiguration.id}`;
